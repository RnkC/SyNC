...
def model(z,t,u,Isyn1,noise_filtered,RM):
    ...
    dwdt = Prel*A*D
    Isynx = w*Isyn1
    dInfluxdt = -40*Isynx*noise_filtered
    dInfluxxdt = RM
    Isyn = Isynx + Influx
    Isynnorm = Isynx 
...
#xrng = [3.6,4.6]
#plt.plot(xrng,ylmt,'b--',label='Limit')
plt.plot(t[2600:12600],RMtrace[2600:12600],'m-',label='Distortion')
plt.yticks(fontsize=20)
plt.xticks(fontsize=20)
plt.ylabel('Distortion Ratio', fontsize=24)
plt.xlabel('Time (in s)', fontsize=24)
...
#xrng = [3.6,4.6]
#plt.plot(xrng,ylmt,'b--',label='Limit')
plt.plot(t[3600:5600],Prel[3600:5600],'m-',label='Distortion')
plt.yticks(fontsize=20)
plt.xticks(fontsize=20)
plt.ylabel('Distortion Ratio', fontsize=24)
plt.xlabel('Time (in s)', fontsize=24)
...
plt.figure(figsize=(8.3,5.8))
#plt.plot(t[3600:4600],noise[3600:4600],'r-',label='Noise')
plt.plot(t[3600:4600],Isyn[3600:4600],'r-',label='Distortion')
plt.yticks(fontsize=20)
plt.xticks(fontsize=20)
